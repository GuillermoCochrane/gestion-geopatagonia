module.exports = function(sequelize, DataTypes) {
  ...
  let config = {
    ...
    deletedAt: false,
    tableName: 'adjuntos_acciones'
  };

  const AdjuntoAccion = sequelize.define(alias, cols, config);

  AdjuntoAccion.associate = function (models) {

    AdjuntoAccion.belongsTo(models.Accion, {
