CREATE DATABASE  IF NOT EXISTS `atahualpa_db` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */;
USE `atahualpa_db`;
-- MySQL dump 10.13  Distrib 8.0.36, for Win64 (x86_64)
--
-- Host: localhost    Database: atahualpa_db
-- ------------------------------------------------------
...
--
-- Table structure for table `wp_chaty_widget_analysis`
--

DROP TABLE IF EXISTS `wp_chaty_widget_analysis`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `wp_chaty_widget_analysis` (
  `id` bigint(11) NOT NULL AUTO_INCREMENT,
  `widget_id` int(11) DEFAULT NULL,
  `channel_slug` varchar(50) DEFAULT NULL,
...
--
-- Table structure for table `wp_easywpsmtp_debug_events`
--

DROP TABLE IF EXISTS `wp_easywpsmtp_debug_events`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Table structure for table `wp_easywpsmtp_tasks_meta`
--

DROP TABLE IF EXISTS `wp_easywpsmtp_tasks_meta`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
) ENGINE=InnoDB AUTO_INCREMENT=3411 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `wp_wc_admin_note_actions` (
  ...
  PRIMARY KEY (`action_id`),
  KEY `note_id` (`note_id`)
) ENGINE=InnoDB AUTO_INCREMENT=1517 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-02-04 15:55:43
