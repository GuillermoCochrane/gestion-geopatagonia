//Middleware de ruta que no permite el acceso a usuarios sin rol de adminitrador
const utilities = require("../../../utilities/utilities");
function adminAccessMDW (req,res, next) {
    ...
    try{
        ...
        if((rol != 5)) return res.redirect("/forbidden");
        next();
    } catch (error) {
