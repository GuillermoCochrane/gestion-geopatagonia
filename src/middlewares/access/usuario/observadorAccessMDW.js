//Middleware de ruta que no permite el acceso a usuarios sin rol de observador
const utilities = require("../../../utilities/utilities");
function observadorAccessMDW (req,res, next) {
    ...
    try{
        ...
        if((rol != 4)) return res.redirect("/forbidden");
        next();
    } catch (error) {
...
module.exports = observadorAccessMDW