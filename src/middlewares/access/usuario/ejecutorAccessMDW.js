//Middleware de ruta que no permite el acceso a usuarios sin rol de ejecutor
const utilities = require("../../../utilities/utilities");
function ejecutorAccessMDW (req,res, next) {
    ...
    try{
        ...
        if((rol != 1)) return res.redirect("/forbidden");
        next();
    } catch (error) {
...
module.exports = ejecutorAccessMDW